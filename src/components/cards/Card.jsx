...
{/* <div class="flex flex-col items-center p-6 rounded-2xl shadow-md">
  <img
    className="mt-1"
    src="/images/cards-images/language-support.png"
    alt="Language-support"
  />
  <h3 class="text-lg font-semibold mt-6">Multilingual Support</h3>
  <p class="text-center text-gray-600 text-sm">
    Write in any language and even provide instructions in your native tongue.
  </p>
</div>; */}

{
  /* <section>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 p-6 bg-white">
          <div class="flex flex-col items-center p-6 bg-amber-50 rounded-2xl shadow-md">
            <div class="text-4xl mb-3">🤖</div>
            <h3 class="text-lg font-semibold">Advanced AI Models</h3>
            <p class="text-center text-gray-600 text-sm">
              Access multiple frontier models like Claude, GPT-4, Command R+,
              and Mistral Large.
            </p>
          ...
          <div class="flex flex-col items-center p-6 bg-amber-50 rounded-2xl shadow-md">
            <div class="text-4xl mb-3">🔤🌍</div>
            <h3 class="text-lg font-semibold">Multilingual Support</h3>
            <p class="text-center text-gray-600 text-sm">
              Write in any language and even provide instructions in your native
              tongue.
            </p>
          </div>
          <div class="flex flex-col items-center p-6 bg-amber-50 rounded-2xl shadow-md">
            <div class="text-4xl mb-3">🖋️</div>
            <h3 class="text-lg font-semibold">Customizable Writing</h3>
            <p class="text-center text-gray-600 text-sm">
              Define your unique writing style, genre, and narrative structure.
            </p>
          </div>
          <div class="flex flex-col items-center p-6 bg-amber-50 rounded-2xl shadow-md">
            <div class="text-4xl mb-3">👥</div>
            <h3 class="text-lg font-semibold">Character Development</h3>
            <p class="text-center text-gray-600 text-sm">
              Create deep, evolving characters with detailed backgrounds and
              personalities.
            </p>
