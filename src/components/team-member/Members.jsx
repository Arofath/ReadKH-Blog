export default function Members({ profile, name, team, role }) {
  return (
    <>
      <div className="w-full max-w-sm bg-white border border-[#AAAAAA] rounded-2xl p-8 flex flex-col items-center">
        ...
        <small className="text-sm text-gray-500 mt-2">{team}</small>
        <p className="text-sm uppercase text-white font-medium mt-2 bg-[#A27B5C] w-45 py-3 rounded-3xl">
          {role}
        </p>
...
//       <img className="w-full h-full object-cover" src={profile} alt="member" />
//     </div>
//     <h5 className="mt-3 text-xl font-semibold text-gray-900">{name}</h5>
//     <small className="text-sm text-gray-500 mt-2">{team}</small>
//     <p className="text-sm uppercase text-[#A27B5C] font-medium mt-2">{role}</p>
