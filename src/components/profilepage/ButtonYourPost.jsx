...
export default function ButtonYourPost() {
  ...
  const fetchBlogs = async (authorId, categoryId) => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BASE_URL}/blogs?author_id=${authorId}&category_id=${categoryId}`
      );
  ...
  if (loading) return <p className="text-center text-gray-600 text-lg">Loading blogs...</p>;
              ...
              >
                ...
                <div className="w-full sm:w-1/3 md:w-1/4 ">
                  <div className="relative aspect-[4/3] rounded-lg overflow-hidden cursor-pointer">
                    <img
                      src={post.thumbnail || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAj4_bJnqM046vfn4p9AsD79Hgy3mDlzCzTA&s"}
                      alt="thumbnail"
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center mb-2">
                    ...
                    <span className="ml-2 text-sm font-medium text-gray-700 cursor-pointer">John Doe</span>
                    <span className="ml-2 text-xs text-gray-500 cursor-pointer">25 Jan 2025</span>
                  </div>
